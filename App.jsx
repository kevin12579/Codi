      ...
      {({ timeLeft, formatTime }) => (
        ...
        <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans antialiased flex w-screen">
          ...
          <aside className="w-64 bg-white border-r border-[#e2e8f0] flex flex-col shrink-0 sticky top-0 h-screen z-20">
            ...
            <nav className="px-4 py-6 space-y-1.5 flex-1 overflow-y-auto min-h-0">
              ...
              <button
                ...
                className={`w-full px-4 py-3 rounded-xl text-sm font-medium flex items-center gap-2 ${
                  activeTab === 'workflow-dashboard' ? 'bg-[#e6f0ff] text-[#0066ff]' : 'text-slate-600 hover:bg-slate-50'
                }`}
              >
                <span className={`w-1.5 h-1.5 rounded-full ${
              ...
              <button
                ...
                className={`w-full px-4 py-3 rounded-xl text-sm font-medium flex items-center gap-2 ${
                  activeTab === 'mcp-hub' ? 'bg-[#e6f0ff] text-[#0066ff]' : 'text-slate-600 hover:bg-slate-50'
                }`}
              >
                <span className={`w-1.5 h-1.5 rounded-full ${
                  activeTab === 'mcp-hub'
              ...
              <button
                ...
                className={`w-full px-4 py-3 rounded-xl text-sm font-medium flex items-center gap-2 ${
                  activeTab === 'event-log' ? 'bg-[#e6f0ff] text-[#0066ff]' : 'text-slate-600 hover:bg-slate-50'
                }`}
              >
                <span className={`w-1.5 h-1.5 rounded-full ${
                  activeTab === 'event-log'
          ...
          <main className="flex-1 overflow-y-auto px-10 py-10 min-h-screen">
            ...
            {/* TODO: 합치기 전 주석 처리 - 새 페이지 라우트 */}
            {/* {activeTab === 'mcp-hub' && <MCPHub />} */}
            {/* {activeTab === 'event-log' && <EventLog />} */}
            {/* {activeTab === 'workflow-dashboard' && <WorkflowDashboard />} */}
          </main>
        </div>
      )}
    </SessionManager>
