    ...
    return (
        ...
        <div className="grid grid-cols-2 items-end mb-2">
            ...
            <div className="flex items-center gap-2">
                ...
                <h1 className="text-3xl font-black text-[#0f172a] tracking-tight">레포지토리 관리</h1>
            </div>
            </div>
        ...
        {!loading && repositories.map((repo) => (
            <div key={repo.id} className="bg-white border border-[#e2e8f0] rounded-2xl p-6 shadow-sm space-y-4">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                <h3 className="text-base font-bold text-slate-900">{repo.fullName}</h3>
                ...
                repo.isActive ? 'text-emerald-600 bg-emerald-50 border-emerald-200' : 'text-slate-500 bg-slate-50 border-slate-200'
                }`}>
