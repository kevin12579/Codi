    ...
    return (
        ...
        <div className="grid grid-cols-2 items-end mb-2">
            ...
            <div className="flex items-center gap-2">
                ...
                <h1 className="text-3xl font-black text-[#0f172a] tracking-tight">MCP 연결 가이드</h1>
            </div>
            </div>
        ...
        <div className="bg-white border border-[#e2e8f0] rounded-2xl p-6 shadow-sm space-y-4">
            ...
            <div className="flex items-center space-x-2">
                ...
                <h3 className="text-base font-bold text-slate-900">MCP Inspector</h3>
            </div>
        ...
        <div className="bg-white border border-[#e2e8f0] rounded-2xl p-6 shadow-sm space-y-4">
            ...
            <div className="flex items-center space-x-2">
                ...
                <h3 className="text-base font-bold text-slate-900">Claude Desktop</h3>
            </div>
    ...
    "mcpServers": {
        ...
        <div className="bg-white border border-[#e2e8f0] rounded-2xl p-6 shadow-sm space-y-4">
            ...
            <div className="flex items-center space-x-2">
                ...
                <h3 className="text-base font-bold text-slate-900">Cursor</h3>
            </div>
        ...
        {/* 안내 */}
        <div className="bg-[#e6f0ff] border border-[#bfdbfe] rounded-2xl p-5">
