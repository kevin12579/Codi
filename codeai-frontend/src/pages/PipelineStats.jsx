    ...
    return (
        ...
        <div className="grid grid-cols-2 items-end mb-2">
            ...
            <div className="flex items-center gap-2">
                ...
                <h1 className="text-3xl font-black text-[#0f172a] tracking-tight">파이프라인 통계</h1>
            </div>
            </div>
            ...
            {['7d', '30d', '90d'].map((p) => (
                ...
                className={`px-3 py-1 rounded-lg text-xs font-bold border transition-all ${
                    period === p ? 'bg-[#0066ff] text-white border-[#0066ff]' : 'bg-white text-slate-500 border-slate-200 hover:border-[#0066ff] hover:text-[#0066ff]'
                }`}>
        ...
        {!loading && stats && (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <p className="text-3xl font-black text-[#0f172a]">{stats.totalExecutions}</p>
                </div>
                <div className="bg-white border border-[#e2e8f0] rounded-2xl p-5 shadow-sm">
            ...
            <div className="bg-white border border-[#e2e8f0] rounded-2xl p-6 shadow-sm">
                ...
                <BarChart data={stats.dailyStats} margin={{ top: 4, right: 4, left: -20, bottom: 0 }} barSize={period === '7d' ? 32 : period === '30d' ? 14 : 8}>
                    ...
                    <Tooltip contentStyle={{ fontSize: 12, borderRadius: 8, border: '1px solid #e2e8f0' }} labelFormatter={formatDate} />
            ...
            <div className="bg-white border border-[#e2e8f0] rounded-2xl p-6 shadow-sm">
                <h3 className="text-sm font-bold text-slate-900 mb-4">AI 엔진별 사용 현황</h3>
                ...
                <div className="flex items-center justify-center gap-8">
                    ...
                    {(() => {
                        ...
                        return (
                            ...
                            <div className="flex items-center gap-2">
                                <span className="w-2.5 h-2.5 rounded-sm inline-block flex-shrink-0" style={{ backgroundColor: ['#0066ff', '#f43f5e', '#10b981'][i % 3] }} />
                                <span className="text-sm text-slate-600">{engine}</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="text-sm font-bold text-slate-900">{count}회</span>
